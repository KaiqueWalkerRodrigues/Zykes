...
try {
    ...
    $stmt = $pdo->prepare(
        "INSERT INTO lente_tratamentos (nome, created_at, updated_at) 
    ...
    echo json_encode([
        "status"              => "success",
        "message"             => "Tratamento de lente cadastrado com sucesso.",
        "id_tratamento_lente" => $novo_id
    ]);
} catch (PDOException $e) {
    http_response_code(500);
    echo json_encode([
        "status"  => "error",
        "message" => "Erro ao cadastrar o tratamento de lente.",
